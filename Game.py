...
def printBoard(board):
    print(
        board["top-L"].center(5)
        + "|".ljust(3)
        + board["top"].center(1)
        + "|".rjust(3)
        + board["top-R"].center(5)
    )
    print("-----------------")
    print(
        board["mid-L"].center(5)
        + "|".ljust(3)
        + board["mid"].center(1)
        + "|".rjust(3)
        + board["mid-R"].center(5)
    )
    print("-----------------")
    print(
        board["low-L"].center(5)
        + "|".ljust(3)
        + board["low"].center(1)
        + "|".rjust(3)
        + board["low-R"].center(5)
    )
    print("\n")
...
def play(board: dict, start: bool = 1):
    ...
    for i in range(9):
        ...
        while True:
            location = input(
                f"Its is {char}'s turn input your prefered location (1-9): "
            )
